...
\cventry{Apr 2024 - current}{Data Engineer}{NASDAQ, Vilnius}{}{}{
  Maintain a small internal data warehouse for the Internal Audit team.
  \begin{itemize}
  ...
  \item Onboard new data sources, debug old ones.
  \end{itemize}
}
...
\cvitem{}{
  \begin{itemize}
  \item For data analysis and modelling, I absolutely love \emph{R} with 5+ years of experience. Similar amount of \emph{Python}.
